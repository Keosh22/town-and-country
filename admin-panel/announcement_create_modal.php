        ...
        <form action="announcement_create.php" method="POST" id="create_announcement_form">
          <div class="row gy-3">
            <div class="col-md-6">
              ...
              <input type="text" name="about" id="about" class="form-control" placeholder="max: 35 characters" maxlength="35">
            </div>
            <div class="col-md-6">
            ...
            <div class="col">
              ...
              <textarea name="content" id="content" rows="10"  wrap="hard"  class="form-control" placeholder="max: 300 characters" maxlength="300"></textarea>
            </div>
